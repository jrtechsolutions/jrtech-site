...
export function WhatsAppFloat() {
  ...
  return (
    <TrackedWhatsAppLink
      ...
      className="whatsapp-float fixed bottom-5 right-5 z-[60] flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_4px_16px_rgba(22,37,61,0.28)] transition-transform duration-150 hover:scale-105 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ink lg:bottom-7 lg:right-7"
    >
      <svg
        width="28"
        height="28"
